/**
 * CPLM-aligned navigation icons (Material Design paths, no extra deps).
 * Matches @mui/icons-material glyphs used in cplm-web-ui src/navigation.tsx.
 */

/** @param {{ size?: number, children: import('react').ReactNode }} props */
function SvgIcon({ size = 18, children }) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
const ICON_PATHS = {
  spaceDashboard:
    'M4 13h6v-2H4v2zm0 4h6v-2H4v2zm0 4h6v-2H4v2zm8-12v2h12V9H12zm0 4h12v-2H12v2zm0 4h12v-2H12v2zm0 4h12v-2H12v2z',
  eventNote:
    'M17 10H7v2h10v-2zm2-7h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z',
  editNote:
  ...
  precisionManufacturing:
    'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm3-5c0 1.66-1.34 3-3 3s-3-1.34-3-3 1.34-3 3-3 3 1.34 3 3z',
  tune:
    'M3 17v2h6v-2H3zM3 5v2h10V5H3zm10 16v-2h8v-2h-8v-2h-2v6h2zM7 9v2H3v2h4v2h2V9H7zm14 4v-2H11v2h10zm-6-4h2V7h4V5h-4V3h-2v6z',
  factory:
    'M22 22H2v-2h20v2zM20 9h-3V4h-2v5H9V4H7v5H4l5 8v5h6v-5l5-8z',
  notifications:
  ...
  menuBook:
    'M21 5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h4c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2h-4zm-6 0c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h4c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2h-4zm-6 0c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h4c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2H9z',
  inventory:
  ...
  palette:
    'M12 3c-4.97 0-9 4.03-9 9 0 4.97 4.03 9 9 9 .83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z',
  gridView:
...
export const NAV_ICONS = {
  dashboard: icon('spaceDashboard'),
  planning: icon('eventNote'),
  workOrders: icon('assignment'),
  gsapSync: icon('sync'),
  entry: icon('editNote'),
  ...
  lossTracker: icon('trendingDown'),
  emailAlerts: icon('email'),
  users: icon('group'),
  machines: icon('precisionManufacturing'),
  config: icon('tune'),
  factoryOverview: icon('factory'),
  lineOverview: icon('accountTree'),
  monitor: icon('tv'),
};

export const NAV_GROUP_ICONS = {
  overview: icon('gridView', 20),
...
export const LOGOUT_ICON = icon('logout');
export const MENU_ICON = icon('menu', 20);
export const EXPAND_LESS_ICON = icon('expandLess', 18);
export const EXPAND_MORE_ICON = icon('expandMore', 18);
export const LIGHT_MODE_ICON = icon('lightMode', 20);
export const DARK_MODE_ICON = icon('darkMode', 20);
export const THEME_ICON = icon('palette', 18);

/** @param {import('react').ReactNode} iconNode */
export function renderNavIcon(iconNode) {
